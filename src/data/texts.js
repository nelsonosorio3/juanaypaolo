...
export const texts = {
    en: {
      ...
      recArrival: "The José Maria Córdoba International Airport (MDE) is on the outskirts of Medellín in Rionegro. The Uber is about $30 dollars. You can also take a bus from the airport to the “San Diego” station (in Medellin) and take a taxi/uber from there to your lodging. This will be a cheaper option!",
    ...
    es: {
      ...
      recArrival: "El aereopuerto internacional José Maria Córdoba (MDE) queda a las afueras de Medellín en Rionegro. El Uber son aproximadamente $30 dólares. También pueden tomar un bus a la salida del aeropuerto para llegar a la estación de San Diego (dentro de Medellín) y de ahí tomar un taxi/uber a su alojamiento. Esto será más económico!",
